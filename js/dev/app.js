...
function bildSliders() {
  ...
  if (sliders)
    sliders.forEach((slider) => {
      ...
      for (const slide2 of slider.children) slide2.classList.add("swiper-slide");
    });
}
bildSliders();
function initSliders() {
  if (document.querySelector(".boilers-slider__slider")) {
    new Swiper(".boilers-slider__slider", {
      modules: [Navigation],
      observer: true,
      observeParents: true,
      slidesPerView: 1,
      ...
      //lazy: true,
      navigation: {
        prevEl: ".boilers-slider__nav--prev",
        nextEl: ".boilers-slider__nav--next"
      },
      breakpoints: {
        551: {
          slidesPerView: 2
  ...
  if (document.querySelector(".item__slider")) {
    let swiperThumbs = new Swiper(".item__slider-thumb", {
      modules: [Navigation],
      observer: true,
      observeParents: true,
      slidesPerView: 2,
...
function menuInit() {
  let iconMenu = document.querySelector("[data-fls-menu]");
  ...
  if (iconMenu && menuBody) {
    document.addEventListener("click", function(e) {
      ...
      if (document.documentElement.hasAttribute("data-menu-open")) {
        if (!iconMenu.contains(e.target) && !headerBody.contains(e.target)) {
          bodyUnlock();
          document.documentElement.removeAttribute("data-menu-open");
        }
      }
